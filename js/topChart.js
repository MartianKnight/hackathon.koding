...
window.onload = function () {
    ...
    var width = 800,
        ...
        r = Raphael("topChart", width, height),
    ...
    for (var i = 0, ii = labels.length; i < ii; i++) {
        ...
        (function (x, y, data, lbl, dot) {
            ...
            rect.hover(function () {
                ...
                // TODO: Change this to allow data to be changed
                label[1].attr({text: lbl + " Severity"}).show().stop().animateWith(frame, anim, {transform: ["t", lx, ly]}, 200 * is_label_visible);
